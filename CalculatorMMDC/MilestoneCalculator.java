...
public class MilestoneCalculator extends JFrame {
    ...
    public MilestoneCalculator() {
        ...
        infoPanel.setPreferredSize(new Dimension(150, 80)); // Set input panel size (width, height)
        ...
        JLabel terminalAssessmentLabel = new JLabel("Terminal Assessment (%): ");
    ...
    private class CalculateButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                double milestone1Points = milestone1 * 0.25;
                double milestone2Points = milestone2 * 0.40;
                double terminalAssessmentPoints = terminalAssessment * 0.35;
